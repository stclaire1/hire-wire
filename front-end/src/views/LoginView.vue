      ...
      <div class="rounded-lg bg-white px-6 py-8 shadow-md">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <button 
            type="submit" 
            :disabled="loading" 
            class="cursor-pointer w-full rounded-md bg-blue-600 px-4 py-2 text-white font-medium shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
          >
