      ...
      <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div class="flex justify-between items-center">
          ...
          <button 
            ...
            class="cursor-pointer px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
          >
      ...
      <div v-else-if="!accountsLoading" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
          <button
            ...
            class="cursor-pointer w-full flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors font-medium"
          >
